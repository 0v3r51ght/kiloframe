...
class InstallationTests(unittest.TestCase):
    ...
    def test_installer_preconfigures_requested_integrations(self):
        ...
        self.assertIn("playwright-cli install --skills=agents", install)
        self.assertIn(".agents/skills/playwright-cli/SKILL.md", install)
        self.assertNotIn("playwright-cli install --skills ||", install)
