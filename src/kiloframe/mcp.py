...
be offered to the model alongside the built-in ones. Only the stdio transport is
...
permission layer as everything else. A server that hangs must not hang KiloFrame, so every
...
log = logging.getLogger("kiloframe.mcp")

PROTOCOL_VERSION = "2025-06-18"
CLIENT_INFO = {"name": "KiloFrame", "version": "0.1.0"}
